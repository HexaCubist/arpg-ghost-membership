    ...
    api.member = {
        ...
        async checkoutPlan({
            ...
            if (analyticsData) {
                ...
                metadataObj.ghost_analytics_source_url =
                    analyticsData.source_url;
            }
            return makeRequest({
                url,
                method: "POST",
        ...
        async editBilling({ successUrl, cancelUrl, subscriptionId } = {}) {
            ...
            if (!successUrl) {
                const checkoutSuccessUrl = new URL(siteUrl);
                checkoutSuccessUrl.searchParams.set(
                    "stripe",
            ...
            if (!cancelUrl) {
                const checkoutCancelUrl = window.location.href.startsWith(
                    ...
                    ? new URL(window.location.href)
                    : new URL(siteUrl);
                checkoutCancelUrl.searchParams.set(
                    "stripe",
